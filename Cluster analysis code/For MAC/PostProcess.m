...
%plot 500: distance between gnrtd clusters with 1)itself, 2)nearest All
...
%A file with the name PPP_Iman_DatasetForClusterAnalysis is made in the current directory. PPP stand for Post Process Porduced
